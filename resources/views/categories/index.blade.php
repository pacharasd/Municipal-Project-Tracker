...
<div class="space-y-6 max-w-7xl mx-auto pb-12"
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                        บริหารจัดการหมวดหมู่โครงการ สถิติการจัดสรรงบประมาณ และติดตามความคืบหน้าเฉลี่ย
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="p-5 rounded-2xl bg-white dark:bg-[#181a20] border border-slate-200/80 dark:border-white/10 shadow-sm relative overflow-hidden group hover:border-blue-500/40 transition-all">
            ...
            <div class="mt-3">
                <?= \App\Core\Helper::moneyDisplay($metrics['grand_total_budget'], 'card', 'left', 'text-slate-900 dark:text-white') ?>
            </div>
            <?php 
