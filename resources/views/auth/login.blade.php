        ...
        <div class="lg:col-span-5 bg-gradient-to-br from-[#024a48] via-[#007a78] to-[#044240] p-8 sm:p-10 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div class="flex items-center gap-2.5">
                    <div class="w-12 h-12 rounded-2xl bg-white border border-white/40 p-1.5 shadow-lg shadow-teal-950/20 flex items-center justify-center shrink-0">
                    ...
                    <div class="h-12 px-3 rounded-2xl bg-white border border-white/40 shadow-lg shadow-teal-950/20 flex items-center justify-center shrink-0">
